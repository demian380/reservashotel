...
<body>
    ...
    <!--==============================content================================-->
        <div class="content">
          ...
          <div class="container">
            <h2 class="top-1 p3">Reservas del Empleado</h2>
            ...
            <div class="table-responsive custom-table-responsive">
                ...
                <table class="table custom-table">
                  ...
                  <tbody>
                      ...
                      <% 
                          List<Reserva> reservas = (List) misesion.getAttribute("reservas_de_empleado"); 
                          if (!reservas.isEmpty()){
                    ...
                    <% } else { %>
                                <script> alert ('El Empleado No Tiene Reservas Realizadas.') </script>
                            </tbody>
                        </table>
                    <input class="button" type="submit" value="Volver"/>
                    <% } %>
