...
<html lang="es">
<head>
<title>Hotel - Consulta de Reservas</title>
<meta charset="utf-8">
...
<body>
    ...
    <!--==============================content================================-->
        <div class="content">
          ...
          <div class="container">
            <h2 class="top-1 p3">Consulta de Reservas por Fecha</h2>
                <% 
                    SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");  
                    String fecha_c = formato.format(misesion.getAttribute("fecha_consulta"));
                %>
                <h3>Fecha de las Reservas: <span style="color: #28a745"> <%= fecha_c %> </span></h3>
                ...
                <div class="table-responsive custom-table-responsive">
                    ...
                    <table class="table custom-table">
                      ...
                      <tbody>
                          ...
                          <% 
                              List<Reserva> reservas = (List) misesion.getAttribute("reservas_por_fecha"); 
                              if (!reservas.isEmpty()){
                              //SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");    
                        ...
                        <% } else { %>
                                    <script> alert ('No hay Reservas realizadas en esa fecha.') </script>
                                </tbody>
                            </table>
                        <input class="button" type="submit" value="Volver"/>
                        <% } %>
